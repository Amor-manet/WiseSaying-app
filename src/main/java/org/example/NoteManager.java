...
public class NoteManager {
    ...
    private Map<Integer, Notes> notes = new HashMap<>(); // 노트 객체들을 저장할 맵
    ...
    public void register(String saying, String author) {
        ...
        noteCounter++;
        Notes newNote = new Notes(noteCounter, saying, author);
    ...
    public void listNotes() {
        for (Notes note : notes.values()) {
            System.out.println("ID: " + note.getId() + ", 명언: '" + note.getSaying() + "', 작가: " + note.getAuthor());
        }
